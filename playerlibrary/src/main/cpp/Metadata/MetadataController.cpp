...
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeSetup(JNIEnv *env,
                                                                          jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeRelease(JNIEnv *env,
                                                                            jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeSetDataSource(JNIEnv *env,
                                                                                  jobject instance,
                                                                                  jstring path_) {
    if (metadataRetriever != NULL) {
...
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeGetMetadata__Ljava_lang_String_2(
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeGetMetadata__Ljava_lang_String_2I(
...
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeGetMetadata__(JNIEnv *env,
                                                                                   jobject instance) {
    if (metadataRetriever != NULL) {
...
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeGetFrame__J(JNIEnv *env,
                                                                                jobject instance,
                                                                                jlong timeUs) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeGetFrame__JII(JNIEnv *env,
                                                                                  jobject instance,
                                                                                  jlong timeUs,
                                                                                  jint width,
                                                                                  jint height) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_cgfay_media_Medadata_AVMediaMetadataRetriever_nativeGetCoverPicture(JNIEnv *env,
                                                                                    jobject instance) {
